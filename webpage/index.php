...
if($_SERVER["REQUEST_METHOD"] == 'POST')
{
    ...
    $is_conf_password = $password == $confirm_password;
...
<form action="index.php" method="POST">
    <dl>
        ...
        <dd class="<?= $is_username ? '' : 'not' ?>valid">
            It has to contain at least 5 chars.
        </dd>
        ...
        <dd>
            <input type="password" name="conf_password" value="<?= $confirm_password ?>">
        </dd>
        ...
        <dd class="<?= $is_home_phone ? '' : 'not' ?>valid">
            Only 9 digit. For ex, 97 1234567
        </dd>
        ...
        <dd class="<?= $is_credit_card_num ? '' : 'not' ?>valid">
            Only 16 digit.  For ex, 1234 1234 1234 1234
        </dd>
        ...
        <dd class="<?= $is_credit_card_expiry ? '' : 'not' ?>valid">
             Date dd.MM.yyyy format. For ex, 12.02.2021
        </dd>
        ...
        <dd class="<?= $is_monthly_salary ? '' : 'not' ?>valid">
            following format UZS 200,000.00
        </dd>
        ...
        It should be a floating point number less than or equal 4.5
